...
- Хук проверяет новые уведомления каждые 30 секунд, только когда вкладка видима и окно сайта находится в фокусе. В фоновой вкладке polling и первоначальный GET не выполняются; при возврате на сайт список обновляется сразу.
