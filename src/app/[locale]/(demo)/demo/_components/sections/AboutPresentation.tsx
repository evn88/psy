...
const AboutPresentation = () => (
  <section className="presentation h-full flex items-center justify-center relative text-2xl">
    <h1 className="text-4xl lg:text-5xl font-bold tracking-tight caveat-font">Ćao 👋️</h1>
    <div className="flex flex-col md:flex-row items-center w-full max-w-7xl mx-auto">
      ...
      <div className="md:w-3/5 lg:w-1/2 space-y-8 text-center md:text-left">
        ...
        <div className="space-y-5">
          <h2 className="text-lg font-semibold caveat-font">Для кого эта презентация?</h2>
          <p className="text-2xl text-gray-500 ">Давайте посмотрим немного магии визуализации 🪄</p>
        </div>
      </div>
