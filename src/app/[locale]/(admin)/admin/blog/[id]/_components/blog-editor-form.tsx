...
import { PreviewSizeSwitcher } from './preview-size-switcher';
import { TranslateModal } from './translate-modal';
import { MdxEditorWrapper, BLOG_EDITOR_VIEW_MODE_TARGET_ID } from './mdx-editor-wrapper';
...
const ArticleContent = dynamic(
  () =>
    import('@/app/[locale]/(public)/blog/[slug]/_components/article-content').then(
