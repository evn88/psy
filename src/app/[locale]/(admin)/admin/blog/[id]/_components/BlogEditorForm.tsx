...
import { PreviewSizeSwitcher } from './PreviewSizeSwitcher';
import { TranslateModal } from './TranslateModal';
import { MdxEditorWrapper, BLOG_EDITOR_VIEW_MODE_TARGET_ID } from './MdxEditorWrapper';
import { BLOG_EDITOR_EMPTY_PREVIEW_ICON_CLASS_NAME } from './blog-editor-form.constants';
import { BlogEditorLocaleTabs } from './BlogEditorLocaleTabs';
import { BlogEditorMetadataSection } from './BlogEditorMetadataSection';
...
const ArticleContent = dynamic(
  () =>
    import('@/app/[locale]/(public)/blog/[slug]/_components/ArticleContent').then(
