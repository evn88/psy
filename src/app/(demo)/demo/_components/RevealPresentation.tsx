...
import AmChartsArchitectureExplorer from '@/app/(demo)/demo/_components/sections/AmChartsArchitectureExplorer';
import {ModularitySection} from '@/app/(demo)/demo/_components/sections/ModularitySection';
import {CustomElementsSection} from '@/app/(demo)/demo/_components/sections/CustomElementsSection';
import {FlexibilitySection} from '@/app/(demo)/demo/_components/sections/FlexibilitySection';
import {BestPracticesSection} from '@/app/(demo)/demo/_components/sections/BestPracticesSection';
