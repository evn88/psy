 ...
 * Горизонтальная раскладка: текст + тип в одну строку (grid).
 */
        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="space-y-1.5">
            {question.options.map((option, oIndex) => (
              <div key={`opt-${question.id}-${oIndex}`} className="flex gap-1.5">
                <Input
                  value={option}
 ...
 * Данные автоматически сохраняются в localStorage как черновик.
 */
    ...
    const loadDraft = () => {
      ...
      if (savedDraft) {
        try {
          ...
          // Невалидный JSON черновика — игнорируем
        }
      }
      setIsLoaded(true);
    };
        ...
        <Card>
          <CardHeader className="pb-3">
            <CollapsibleTrigger className="flex items-center justify-between w-full text-left">
              <div>
                ...
                <CardDescription className="mt-1">{t('surveyDetailsDesc')}</CardDescription>
              </div>
              <ChevronDown
          ...
          <CollapsibleContent>
            <CardContent className="space-y-4 pt-0">
              <div className="space-y-1.5">
                <Label htmlFor="survey-title" className="text-xs font-semibold">
                  {t('surveyTitle')}
                </Label>
                <Input
                  id="survey-title"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="survey-desc" className="text-xs font-semibold">
                  {t('surveyDescription')}
                </Label>
                <Textarea
                  id="survey-desc"
